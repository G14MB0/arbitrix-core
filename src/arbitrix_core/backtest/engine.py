...
def _audit_signal_payload(sig: Signal) -> Dict[str, Any]:
    return {
        ...
        "volume": getattr(sig, "volume", None),
        ...
        "valid_until": getattr(sig, "valid_until", None),
        "target_trade_id": getattr(sig, "target_trade_id", None),
        "target_order_id": getattr(sig, "target_order_id", None),
        "close_volume": getattr(sig, "close_volume", None),
        "new_sl": getattr(sig, "new_sl", None),
        "new_tp": getattr(sig, "new_tp", None),
        "new_price": getattr(sig, "new_price", None),
        "risk_multiplier": getattr(sig, "risk_multiplier", None),
